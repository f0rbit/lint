// Exercises every phase-1 addition simultaneously through one define_lint_config()
// output — proves org_rules wiring and de-dupe ordering hold when prefer-pipe,
// no-ambient-effects, no-test-mocks, consistent-type-definitions, and no-console
// are all active at once, not just individually.
...
console.log("combined fixture", created_at, roll, send, run());
